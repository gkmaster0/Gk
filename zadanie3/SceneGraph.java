...
public class SceneGraph extends JPanel {
	...
	private void createWorld() {
		...
		Triangle_2.setScale(0.5, 1).setTranslation(-2.25, 0.5).setColor(new Color(128, 0, 128));
		Triangle_3.setScale(0.5, 0.8).setTranslation(1.5, 1).setColor(new Color(0, 153, 0));
		...
		Polygon_1.setScale(0.3, 0.3).setTranslation(-0.86, -0.42);
		Polygon_2.setScale(0.3, 0.3).setTranslation(0.900, -1.150);
		Polygon_3.setScale(0.25, 0.25).setTranslation(-3, 1.80);
		Polygon_4.setScale(0.25, 0.25).setTranslation(-1.4, 1.18);
		Polygon_5.setScale(0.2, 0.2).setTranslation(0.85, 2.1);
		Polygon_6.setScale(0.2, 0.2).setTranslation(2.15, 1.50);
	...
	public void updateFrame() {
		frameNumber++;	
		Polygon_1.setRotation(frameNumber*1); 
		Polygon_2.setRotation(frameNumber*1); 
		Polygon_3.setRotation(frameNumber*1); 
		Polygon_4.setRotation(frameNumber*1); 
		Polygon_5.setRotation(frameNumber*1); 
		Polygon_6.setRotation(frameNumber*1); 	
	}
