...
public class Lab6 extends GLJPanel implements GLEventListener  {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        for (i = 1; i<= n; i += 1) { //rysowanie boków
        ...
        float sun[] = { 1, 0.5F, 0, 1  };
        gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_SPECULAR, gray, 0);
        gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_EMISSION, sun, 0);
        gl2.glTranslated(25, 6, 10);
        gl2.glEnable(GL2.GL_LIGHT1);

        glut.glutSolidSphere(3, 8, 4);
        gl2.glPopMatrix();
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        gl2.glLightfv(GL2.GL_LIGHT2, GL2.GL_AMBIENT, FloatBuffer.wrap(new float[] {1f,0f,0f,1}));
        gl2.glLightfv(GL2.GL_LIGHT2, GL2.GL_POSITION, FloatBuffer.wrap(new float[] {-20f,-0.5f,0f,1}));
